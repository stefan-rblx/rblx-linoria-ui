...
library.theme = {
    ...
    accentcolor2 = Color3.fromRGB(0, 102, 204),
    ...
    topcolor2 = Color3.fromRGB(19, 19, 19),
    buttoncolor = Color3.fromRGB(41, 41, 41),
    buttoncolor2 = Color3.fromRGB(41, 41, 41),
...
function library:CreateWindow(name, size, hidebutton)
    ...
    function window:CreateTab(name)
        ...
        function tab:CreateConfigSystem(side)
            ...
            local ConfigName = configSystem.sector:AddTextbox("", "", ConfigName, function() end, "")
            local default = tostring(listfiles(configSystem.configFolder)[1] or ""):gsub(configSystem.configFolder .. "\\", ""):gsub(".txt", "")
            local Config = configSystem.sector:AddDropdown("Config selected", {}, default, false, function() end, "")
            ...
            configSystem.Create = configSystem.sector:AddButton("Create", function()
                ...
                if ConfigName:Get() and ConfigName:Get() ~= "Config name" then
                    local config = {}
